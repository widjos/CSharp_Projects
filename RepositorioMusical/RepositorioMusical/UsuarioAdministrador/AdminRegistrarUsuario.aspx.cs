...
namespace RepositorioMusical.UsuarioAdministrador
{
    ...
    {
        Clases.Insercion miInsert; // Declaro una variable de tipo Insercion
        Clases.Consultas miConsulta; // Declaro una variable de tipo Consultas 
        ...
        protected void CrearCuenta_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int id = (miConsulta.retornarIdUser(CorreoElect.Text, Contraseña.Text));

                miInsert.insertarUsuarioActivo( id);
                ...
                Mensaje.Text = "Usuario agregado exitosamente";
